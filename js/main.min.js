/**
 * Blake Trahan
 * https://blaketrahan.github.io
 * 2018
 */
!function(){"use strict";!function(e){for(var t=0,i=["ms","moz","webkit","o"],n=0;n<i.length&&!e.requestAnimationFrame;++n)e.requestAnimationFrame=e[i[n]+"RequestAnimationFrame"],e.cancelAnimationFrame=e[i[n]+"CancelAnimationFrame"]||e[i[n]+"CancelRequestAnimationFrame"];e.requestAnimationFrame||(e.requestAnimationFrame=function(i,n){var r=(new Date).getTime(),o=Math.max(0,16-(r-t)),a=e.setTimeout(function(){i(r+o)},o);return t=r+o,a}),e.cancelAnimationFrame||(e.cancelAnimationFrame=function(e){clearTimeout(e)})}(window);var e=function(e){this.canvas=[],this.mouse={x:0,y:0},this.hot_id=-1,this.fps=30,this.frame_duration=1e3/this.fps,this.accumulator=0,this.previous=0,this.get_mouse_pos=function(e,t){var i=e.getBoundingClientRect(),n=this.mouse.x,r=this.mouse.y;return this.mouse.x=t.clientX-i.left,this.mouse.y=t.clientY-i.top,{prev_x:n,prev_y:r,x:this.mouse.x,y:this.mouse.y}}.bind(this);for(var t=document.getElementsByClassName("animatioion"),i=0;i<t.length;i++)t[i].setAttribute("aioindex",i),this.canvas.push(new function(e){var t=this;return t.id=e.id||null,t.el=e.el||null,t.w=0,t.h=0,t.x=0,t.y=0,t.prev_x=0,t.prev_y=0,t.render_x=0,t.render_y=0,t.amplitude=0,t.period=2e3,t.width=16,t.height=32,t.speed_multiplier=15,t.is_on=!1,t.color="#000000",t.parent=e.parent||null,t.trigger=e.trigger||function(){console.log("No trigger set.")},t.trigger.bind(t),null==t.el&&console.log("Error: missing canvas."),t.w=t.el.width,t.h=t.el.height,t.w_weighted=10,t.h_weighted=10,t.el.width=2*t.w,t.el.height=2*t.h,t.el.style.width=t.w+"px",t.el.style.height=t.h+"px",null==t.parent&&console.log("Error: missing parent."),t.update=function(e,t){var i=this,n=e-t,r=i.w,o=i.h;i.prev_x=i.x,i.prev_y=i.y,i.h>i.w?i.is_on?(i.x=i.parent.mouse.x-r/2,i.render_x=i.x,i.prev_x=i.x):(i.x=i.amplitude*Math.sin(n*i.speed_multiplier*Math.PI/i.period),i.amplitude*=.98,i.amplitude<=1&&(i.amplitude=0)):i.is_on?(i.y=i.parent.mouse.y-o/2,i.render_y=i.y,i.prev_y=i.y):(i.y=i.amplitude*Math.sin(n*i.speed_multiplier*Math.PI/i.period),i.amplitude*=.98,i.amplitude<=1&&(i.amplitude=0))}.bind(t),t.display=function(e){var t=this;t.render_x=(t.x-t.prev_x)*e+t.prev_x,t.render_y=(t.y-t.prev_y)*e+t.prev_y;var i=t.w_weighted,n=t.h_weighted,r=t.el.getContext("2d",{antialias:!1,depth:!1});r.fillStyle="#f9f9f9",r.fillRect(0,0,t.el.width,t.el.height),r.save(),r.scale(2,2),t.h>t.w?(t.h_weighted=(13*t.h_weighted+t.h)/14,t.w_weighted=t.w,r.beginPath(),r.lineWidth=t.width,r.strokeStyle=t.color,r.moveTo(i/2,10),r.quadraticCurveTo(i/2+t.render_x,n/2,i/2,n-10),r.stroke(),r.closePath()):(t.w_weighted=(13*t.w_weighted+t.w)/14,t.h_weighted=t.h,r.beginPath(),r.lineWidth=t.width,r.strokeStyle=t.color,r.moveTo(10,n/2),r.quadraticCurveTo(i/2,t.render_y+n/2,i-10,n/2),r.stroke(),r.closePath()),r.restore()}.bind(t),t.el.addEventListener("mousemove",function(e){var t=this;t.parent.hot_id=t.id;var i=t.parent.get_mouse_pos(t.el,e);t.trigger(i)}.bind(t),!1),t.el.addEventListener("mouseout",function(e){var t=this;if(t.is_on){var i=t.w,n=t.h;t.amplitude=n>i?i-20:n-20,t.amplitude*=.5,t.is_on=!1}}.bind(t),!1),t.el.addEventListener("mouseenter",function(e){var t=this,i=t.el.getBoundingClientRect();t.parent.prev_x=e.clientX-i.left,t.parent.prev_y=e.clientY-i.top,t.parent.mouse.x=t.parent.prev_x,t.parent.mouse.y=t.parent.prev_y}.bind(t),!1),t}({el:t[i],parent:this,id:i,trigger:function(e){var t=this;if(t.h>t.w){i=t.w/2+t.x;t.is_on||(e.x>i&&e.x-i<10||e.x<i&&i-e.x<10?t.is_on=!0:(e.prev_x<i&&e.x>=i||e.prev_x>i&&e.x<=i)&&(t.is_on=!0))}else{var i=t.h/2+t.y;t.is_on||(e.y>i&&e.y-i<10||e.y<i&&i-e.y<10?t.is_on=!0:(e.prev_y<i&&e.y>=i||e.prev_y>i&&e.y<=i)&&(t.is_on=!0))}}}));if(void 0===window.performance.now?this.get_time=void 0===Date.now?(new Date).getTime():Date.now():this.get_time=window.performance.now.bind(window.performance),this.start_time=this.get_time(),0==this.canvas.length)return console.log("No canvases found. Removing Animatioion object."),null;this.loop=function(){requestAnimationFrame(this.loop);var e=this.get_time(),t=e-this.previous;if(t>1e3&&(t=this.frame_duration),this.accumulator+=t,this.accumulator>=this.frame_duration){for(n=0;n<this.canvas.length;n++)this.canvas[n].update(this.get_time(),this.start_time);this.accumulator-=this.frame_duration}for(var i=this.accumulator/this.frame_duration,n=0;n<this.canvas.length;n++)this.canvas[n].display(i);this.previous=e}.bind(this),this.random_color=function(){for(var e="#",t=0;t<6;t++)e+="0123456789ABCDEF"[Math.floor(16*Math.random())];return e},this.run=function(){return this.loop(),this}.bind(this)};setTimeout(function(){function isCanvasSupported(){var elem = document.createElement('canvas');return !!(elem.getContext && elem.getContext('2d'));}if(!isCanvasSupported){document.getElementById("Animations").outerHTML = "";
    }else{(new e).run()}},900)}();
...
function set_scrollbar_width(){var e=document.createElement("div");e.className="scrollbar-measure",document.body.appendChild(e);var t=e.offsetWidth-e.clientWidth;document.body.removeChild(e);var d="html.theater body{margin-right:"+t+"px;}html.theater .theater-overlay{border-right:"+t+"px solid rgba(0,0,0,0.85);}",a=document.head||document.getElementsByTagName("head")[0],l=document.createElement("style");l.type="text/css",l.styleSheet?l.styleSheet.cssText=d:l.appendChild(document.createTextNode(d)),a.appendChild(l)}set_scrollbar_width();