(function() {
  ...
  // example : <canvas width="90" height="140" class="animashoon"></canvas>

  var Animashoon = function(options)
  {
    "use strict";
    ...
    var CanvasObj = function(options)
    {
	  ...
	  var el = document.getElementsByClassName("animashoon");
    ...
    if (this.canvas.length == 0) {
      console.log("No canvases found. Removing Animashoon object.");
      return null;
    }
 	...
 	var animashoon = (new Animashoon()).run();
